...
// REMPLISSAGE CB (ou CR)
   for(uint32_t i = 0 ; i < 8 ; i++ ){
         for(uint32_t j = 0 ; j < 8 ; j++ ){
           
           if (i<4 && j < 4){
            int8_t moyenne = ( Cb_bloc0[2*i][2*j] + Cb_bloc0[2*i][2*j+1] + Cb_bloc0[2*i+1][2*j] + Cb_bloc0[2*i+1][2*j+1] )*(0.25) ;
            CB[i][j]=moyenne ; 
           ...
           uint8_t k=j-4;
            int8_t moyenne = ( Cb_bloc1[2*i][2*k] + Cb_bloc1[2*i][2*k+1] + Cb_bloc1[2*i+1][2*k] + Cb_bloc1[2*i+1][2*k+1] )*(0.25) ;
            CB[i][j]=moyenne ; 
              ...
              uint8_t k=i-4;
              int8_t moyenne = ( Cb_bloc2[2*k][2*j] + Cb_bloc2[2*k][2*j+1] + Cb_bloc2[2*k+1][2*j] + Cb_bloc2[2*k+1][2*j+1] )*(0.25) ;
            CB[i][j]=moyenne ; 
              ...
              uint8_t  k2=j-4 ;
                ...
                int8_t moyenne = ( Cb_bloc3[2*(k1)][2*(k2)] + Cb_bloc3[2*(k1)][2*(k2)+1] + Cb_bloc3[2*(k1)+1][2*(k2)] + Cb_bloc3[2*(k1)+1][2*(k2)+1] )*(0.25) ;
            CB[i][j]=moyenne ; 
            }
...
// REMPLISSAGE CB 
   for(uint32_t i = 0 ; i < 8 ; i++ ){
         for(uint32_t j = 0 ; j < 8 ; j++ ){
           ...
           if (j < 4){
            int8_t moyenne = ( Cb_bloc0[i][2*j] + Cb_bloc0[i][2*j+1] )*(0.5) ;
            CB[i][j]=moyenne ; 
              ...
              uint8_t k=j-4;
            int8_t moyenne = ( Cb_bloc1[i][2*k] + Cb_bloc1[i][2*k+1] )*(0.5) ;
            CB[i][j]=moyenne ; 
...
// REMPLISSAGE CB (la moyenne )
   for(uint32_t i = 0 ; i < 8 ; i++ ){
         for(uint32_t j = 0 ; j < 8 ; j++ ){
           
           if (i < 4){
            int8_t moyenne = ( Cb_bloc0[2*i][j] + Cb_bloc0[2*i+1][j] )*(0.5) ;
            CB[i][j]=moyenne ; 
              ...
              uint8_t k=i-4;
            int8_t moyenne = ( Cb_bloc1[2*k][j] + Cb_bloc1[2*k+1][j] )*(0.5) ;
            CB[i][j]=moyenne ; 
...
if (error== 1){
    printf(" tes facteurs ne respectent pas les restrictions \n");
    return ; 
}
